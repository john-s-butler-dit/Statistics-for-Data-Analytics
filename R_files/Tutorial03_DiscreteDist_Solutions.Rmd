...
```{r , include=FALSE}
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning = FALSE,  fig.pos = "H",dpi = 300)
```
...
names(df)<- c("i","x","p(x)")
kable(t(df),format = "latex", caption = "Q1: Probability Mass Function.",table.envir = "table",position = "h")
